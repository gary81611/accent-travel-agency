    ...
    <footer className="bg-brand-charcoal text-white">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Specializing in Group Travel and Tours since 1981
            </p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-2 text-sm text-gray-300">
              <p>
                <a href="tel:8065706640" className="hover:text-brand-gold-light transition-colors">
                  (806) 570-6640
                </a>
                <span className="text-gray-500 ml-1">— Call or Text</span>
              </p>
              <p>
                <a href="mailto:accenttravelgroups@gmail.com" className="hover:text-brand-gold-light transition-colors">
                  accenttravelgroups@gmail.com
                </a>
              </p>
              <p>6006 Tuscany Village<br />Amarillo, TX 79119</p>
        ...
        <div className="border-t border-gray-600 mt-8 pt-6 text-center text-xs text-gray-500">
          <p>&copy; {new Date().getFullYear()} Accent Travel Agency. All rights reserved.</p>
          <p className="mt-1">Serving Amarillo, TX and surrounding areas.</p>
        </div>
      </div>
    </footer>
  );
